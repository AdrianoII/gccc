...
gccc.o: obj/lexParser.o obj/syntaxParser.o obj/semanticParser.o obj/intermediateCodeGeneration.o
	gcc  -Wall -Wextra -g -fno-sanitize=all src/main.c src/utils.h obj/lexParser.o obj/syntaxParser.o obj/semanticParser.o obj/intermediateCodeGeneration.o -o obj/gccc.o
